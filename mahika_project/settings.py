"""
Django settings for mahika_project project.
...
SECRET_KEY = "django-insecure-!d6@pz*$*mb1gb*2y9ngni$vurfbjy0_fxnxaqc9=)eitv%%%m"
...
ROOT_URLCONF = "mahika_project.urls"
...
WSGI_APPLICATION = "mahika_project.wsgi.application"
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    BASE_DIR / 'frontend/assets', # <-- This tells Django where your CSS/JS is
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'chittigunashaker6@gmail.com'
